...
/*  QUESTION 2
    SELECT EMP_NUM, EMP_LNAME, EMP_FNAME FROM EMPLOYEESS;*/

/*  QUESTION 3
    SELECT DISTINCT JOB_CODE FROM EMPLOYEESS;*/

/*  QUESTION 4
    SELECT E.EMP_NUM, E.EMP_LNAME, E.EMP_FNAME, J.JOB_CHG_HOUR
    FROM EMPLOYEESS E
    JOIN JOBSS J ON E.JOB_CODE = J.JOB_CODE;
*/

/*  QUESTION 5
    SELECT JOB_CODE FROM JOBSS WHERE JOB_CODE = '501';*/

/*  QUESTION 6
    SELECT EMP_HIREDATE FROM EMPLOYEESS WHERE EMP_HIREDATE > '01-01-2000';*/

/*  QUESTION 7
    SELECT PROJ_VALUE FROM PROJECTSS WHERE PROJ_VALUE > 2000000;*/

/*  QUESTION 8
    SELECT EMP_LNAME FROM EMPLOYEESS WHERE EMP_LNAME LIKE 'S%';*/

/*  QUESTION 9
    SELECT * FROM EMPLOYEESS WHERE EMP_FNAME LIKE '%A%';*/

/*  QUESTION 10
    SELECT * FROM EMPLOYEESS WHERE JOB_CODE IN ('500', '501', '502');*/

/*  QUESTION 11
    SELECT * FROM EMPLOYEESS WHERE EMP_INITIAL IS NULL;*/

/*  QUESTION 12
    SELECT * FROM ASSIGNMENTSS WHERE ASSIGN_HOURS BETWEEN 3 AND 5; */
